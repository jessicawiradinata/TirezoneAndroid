...
public class CustomersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.customers_recyclerview);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_mystore) {
            startActivity(new Intent(CustomersActivity.this, MyStoreActivity.class));
            return true;
        }
        else if (id == R.id.action_sales) {
            startActivity(new Intent(CustomersActivity.this, SalesActivity.class));
            return true;
        }
            ...
            startActivity(new Intent(CustomersActivity.this, ProfileActivity.class));
            return true;
        }
    ...
    public static class CustomersViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setButton() {
            detailButton = mView.findViewById(R.id.item_customers);
        }
    }
